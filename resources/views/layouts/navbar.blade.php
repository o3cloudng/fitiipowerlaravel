<nav class="topnav navbar navbar-expand shadow navbar-light bg-white" id="sidenavAccordion">
    <a class="navbar-brand" href="/"><img src="/img/logo_black.jpg" width="100px" height="250px" alt=""></a>
            ...
            <div class="dropdown-menu dropdown-menu-right border-0 shadow animated--fade-in-up"
                ...
                <h6 class="dropdown-header d-flex align-items-center">
                    ...
                    <div class="dropdown-user-details">
                        <div class="dropdown-user-details-name">{{ Auth::user()->firstname }}</div>
                ...
                <a class="" href="{{ url('/logout') }}">
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button type="submit" class="dropdown-item-icon btn btn-danger btn-block">
